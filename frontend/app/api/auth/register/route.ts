// app/api/auth/register/route.ts — Route Handler for register
import { NextRequest, NextResponse } from "next/server";
import { backendRegister } from "@/lib/server-api-client";
...
export async function POST(request: NextRequest) {
  ...
  try {
    const authResponse = await backendRegister(dto);
